    ...
    items: [
      {
        ...
        children: [
          ...
          { id: 'reports-committees-divisionwise', label: 'Division-wise Summary Report', path: '/admin/reports/committees-divisionwise' },
          ...
          { id: 'reports-activity', label: 'Activity Report', path: '/admin/reports/activity' },
        ],
      },
    ],
  },
