...
export default function ActivityReportPage() {
  ...
  return <ReportPageLayout pageTitle="Activity Audit Trail" pageSubtitle="Inspect cross-module admin actions, approvals, and publication flow in one audit view." breadcrumbs={[{ label: 'Admin', path: '/admin/dashboard' }, { label: 'Reports' }, { label: 'Activity Audit Trail' }]} cards={cards} filters={filters} setFilters={setFilters} search={search} setSearch={setSearch} data={data} loading={loading} error={error} onReload={reload} searchPlaceholder="Search activities" tableColumns={[{ key: 'module', label: 'Module' }, { key: 'action', label: 'Action' }, { key: 'title', label: 'Title' }, { key: 'actor', label: 'Actor' }, { key: 'related_entity', label: 'Related Entity' }, { key: 'created_at', label: 'Created At' }]} />;
}
